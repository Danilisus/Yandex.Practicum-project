...
* **Модуль 1** 
    * Базовый Python - Проект 1.
    * Предобработка данных - Проект 2.
    * Исследовательский анализ данных - Проект 3.
    * Статистический анализ данных - Проект 4.
    * Сборный проект - Проект 5.
* **Модуль 2**
    * Введение в машинное обучение - Проект 6.
    * Обучение с учителем - Проект 7.
    * Машинное обучение в бизнесе - Проект 8.
    * Сборный проект 2 - Проект 9.
* **Модуль 3**
    * Линейная алгебра - Проект 10.
    * Численные методы - Проект 11.
    * Временные ряды - Проект 12.
    * NLP. Машинное обучение для текстов - Проект 13.
* **Модуль 4**
    * Computer Vision - Проект 14.
