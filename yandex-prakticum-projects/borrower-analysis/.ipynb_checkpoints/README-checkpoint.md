   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "9                 0      M   сотрудник     0        144425   \n",
       "\n",
       "                      purpose finished_purpose   income_level  income_id  \n",
       "0               покупка жилья     недвижимость        высокий          3  \n",
       "1     приобретение автомобиля       автомобиль        средний          1  \n",
       "2               покупка жилья     недвижимость  выше среднего          2  \n",
       "3  дополнительное образование      образование        высокий          3  \n",
       "4             сыграть свадьбу          свадьба  выше среднего          2  \n",
       "5               покупка жилья     недвижимость        высокий          3  \n",
       "6           операции с жильем     недвижимость        высокий          3  \n",
       "7                 образование      образование        средний          1  \n",
       "8       на проведение свадьбы          свадьба         низкий          0  \n",
       "9     покупка жилья для семьи     недвижимость  выше среднего          2  "
      ]
     },
     "metadata": {},
     "output_type": "display_data"
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "   education_id  family_status_id  children  dob_years  total_income  \\\n",
       "0             0                 0         1         42        253875   \n",
       "1             1                 0         1         36        112080   \n",
       "2             1                 0         0         33        145885   \n",
       "3             1                 0         3         32        267628   \n",
